...
var window: UIWindow?
    ...
    let _ = ApplicationDelegate.shared.application(application, didFinishLaunchingWithOptions: launchOptions)
        ...
        //making sure user is asked to register for push notifiactions
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "AlexanderJerad_ImGood")
    ...
    //MARK: - push notification registrations
